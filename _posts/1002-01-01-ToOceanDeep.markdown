...
<div class="text-center">
    <div class="text-center text-bold" style="border:4px outset clear; display:inline-block; margin-right:10px;">
        <iframe width="784" height="441" src="https://www.youtube.com/embed/YBjCf18ZGJ8" frameborder="0" allowfullscreen></iframe></div>
...
<div class="text-center">
    <div class="text-center text-bold" style="height:300px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_1.png" alt="게임 소개 이미지_1" height="100%"></div>
    <div class="text-center text-bold" style="height:300px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_2.png" alt="게임 소개 이미지_2" height="100%"></div>
    <div class="text-center text-bold" style="height:300px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_3.png" alt="게임 소개 이미지_3" height="100%"></div>
    <div class="text-center text-bold" style="height:300px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_4.png" alt="게임 소개 이미지_4" height="100%"></div>
    <div class="text-center text-bold" style="height:229px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_5.png" alt="게임 소개 이미지_5" height="100%"></div>
    <div class="text-center text-bold" style="height:229px; border:4px outset purple; display:inline-block; margin-right:5px; padding:5px;">
        <img class="scalezoom_small" src="/assets/images/blog/ToOceanDeep/introduce_6.png" alt="게임 소개 이미지_6" height="100%"></div>
    <div style="clear:both;"></div>
</div>
...
<h4 class="text-bold text-center">⦁ 개발 동기 ⦁</h4>
"내가 게임을 만들기 위해 어떤 걸 해야 할까?" 라는 질문을 스스로에게 던지며, 탄탄한 스토리를 가진 오픈 월드 RPG를 만들기로 결심했었습니다.<br>
게임 개발에 필요한 모든 과정을 몸소 경험하여 나만의 노하우를 터득하고 개발 실력을 성장시키고자 하였습니다.<br>
...
<div class="text-center">
    <div class="text-center text-bold" style="height:600px; border:4px; display:inline-block; margin-right:5px; padding:5px;">
        <img src="/assets/images/blog/ToOceanDeep/technique.png" alt="주요 기술 소개" height="100%"></div>
    <div style="clear:both;"></div>
</div>